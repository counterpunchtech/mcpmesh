...
- **`api_version` = `"MAJOR.MINOR"`, and `api_minor` = the integer MINOR** — the
  ...
  for a subject proving one this node revoked, and admission refuses any stored row carrying a
