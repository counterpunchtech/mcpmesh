...
| `-32057` | `self_enroll_detach` — nothing is adopted; this device already presents its own identity (#214, `api_minor >= 60`). Nothing was changed. Safe to treat as "already done" when racing another detach or a `user_key_import`. |
