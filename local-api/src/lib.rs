...
pub use protocol::{
    ...
    PeerDiagnosticsParams, PeerDiagnosticsResult, PeerEndorseParams, PeerEndorseResult,
    PeerHintClearParams, PeerHintClearResult, PeerInfo, PeerIntroduceParams, PeerPath,
    PeerReachability, PeerRemoveParams, PeerRenameParams, PeerRevokeParams, PeerRevokeResult,
    PeerServicesParams, PeerServicesResult, PeerUnrevokeParams, PeerUnrevokeResult, PresencePeer,
    ReachabilitySource, RecentPairing, RegisterServiceParams, RelayInfo, Request, RevokedEndpoint,
    RosterInstallParams, RosterInstallResult, RosterMember, RosterMemberDevice,
